class MircopostImageUploader < CarrierWave::Uploader::Base
  ...
  def store_dir
    "uploads/images/micropost/#{model.id}"
  end
  ...
  #   # do something
  # end
  process :store_dimensions_single
  ...
  protected
    ...
    def secure_token(length=16)
      model.filetoken ||= SecureRandom.hex(length/2)
    end
