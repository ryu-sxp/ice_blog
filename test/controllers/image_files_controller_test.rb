...
class ImageFilesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create image_file" do
    assert_difference('ImageFile.count') do
      post image_files_url, params: { image_file: { image_dimensions: @image_file.image_dimensions, item: @image_file.item, name: @image_file.name, type: @image_file.type } }
    end
  ...
  test "should update image_file" do
    patch image_file_url(@image_file), params: { image_file: { image_dimensions: @image_file.image_dimensions, item: @image_file.item, name: @image_file.name, type: @image_file.type } }
